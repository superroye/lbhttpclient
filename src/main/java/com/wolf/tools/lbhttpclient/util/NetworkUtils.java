/*
       ...
       under the License.
 */
package com.wolf.tools.lbhttpclient.util;
...
public class NetworkUtils {
    ...
    private static NetworkInfo getNetworkInfo() {
        ConnectivityManager conn = (ConnectivityManager) LBHttpClient.getInstance().getApp().getSystemService(Context.CONNECTIVITY_SERVICE);
